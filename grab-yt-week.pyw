...
def main():
    ...
    for country in COUNTRIES:
        ...
        curr_views = elem_id.text.replace(" ","")
        print(curr_views)
        time.sleep(5)
        ...
        if (last_date ==  curr_end_date ): #  если дата уже была
            #  curr_views - данные текущего парсинга, view_values - данные которые были занесены ранее
            #  проверим совпадают ли данные 
            #  
            if (curr_views == view_values):
